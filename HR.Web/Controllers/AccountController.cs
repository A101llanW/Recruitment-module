...
namespace HR.Web.Controllers
{
    public partial class AccountController : Controller
    {
        ...
        private bool SendMfaCode(User user, string overrideMethod)
        {
            ...
            if (!SendMfaEmailSynchronously(recipientEmail.Trim(), code, mfaUser.UserName, mfaUser.Id.ToString(), mfaUser.CompanyId))
            {
                return false;
            }
        ...
        private bool SendMfaEmailSynchronously(string recipientEmail, string code, string username, string userId, int? companyId)
        {
